...
function load(){
 ...
 var c=document.createElement('script');c.src='./customer-click-fix.js?v=2';c.defer=true;document.head.appendChild(c);
 var v=document.createElement('script');v.src='./customer-open-button.js?v=1';v.defer=true;document.head.appendChild(v);
}
