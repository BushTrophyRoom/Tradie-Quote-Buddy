...
function ready(){
  ...
  if(!document.getElementById('tqb-invoice-payment-terms'))load('./invoice-payment-terms.js?v=2','tqb-invoice-payment-terms');
  if(!document.getElementById('tqb-invoice-business-terms-fix'))load('./invoice-business-terms-fix.js?v=1','tqb-invoice-business-terms-fix');
