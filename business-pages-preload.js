...
function ready(){
  if(!document.getElementById('tqb-invoice-nav-bridge'))load('./invoice-nav-bridge.js?v=5','tqb-invoice-nav-bridge');
  if(!document.getElementById('tqb-invoice-click-fix'))load('./invoice-click-fix.js?v=2','tqb-invoice-click-fix');
  if(!document.getElementById('tqb-invoice-mobile-final'))load('./invoice-mobile-final.js?v=1','tqb-invoice-mobile-final');
  if(!document.getElementById('tqb-square-payments'))load('./square-payments.js?v=3','tqb-square-payments');
  if(!document.getElementById('tqb-invoice-square-send-fix'))load('./invoice-square-send-fix.js?v=1','tqb-invoice-square-send-fix');
