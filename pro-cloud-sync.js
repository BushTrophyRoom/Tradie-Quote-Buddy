...
if(choice){saveLocal(cloudQ,cloudS);if(window.refreshTQBDashboard)window.refreshTQBDashboard();setReady(true,cloud.updated_at);setStatus('✓ Cloud backup restored to this device.',true);return null}
