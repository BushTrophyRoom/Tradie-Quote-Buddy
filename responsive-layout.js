...
function install(){
 ...
 s.textContent=`
/* DustyBoots: one responsive layout, not separate mobile/desktop pages */
...
/* Phone/tablet: same content components, simply reflowed to available width */
@media(max-width:800px){
 body{padding:0 0 86px!important;background:#f4f6f8!important}
 .topbar{position:sticky!important;top:0!important;left:0!important;width:100%!important;height:82px!important;padding:8px 14px!important;z-index:1000!important}
 .topbar .brand{min-width:0!important;flex:1!important}
 ...
 .topbar .brand span{font-size:10px!important}
 .topbar .icon-btn{display:block!important;flex:0 0 auto!important;font-size:24px!important;padding:8px!important}
 .bottom-nav{position:fixed!important;left:0!important;right:0!important;bottom:0!important;top:auto!important;width:100%!important;height:auto!important;z-index:10000!important}
 .bottom-nav .nav{min-height:58px!important}
 .screen{max-width:1120px!important;width:100%!important;padding:24px 18px 30px!important;min-height:calc(100vh - 82px)!important}
 .screen#dashboard{max-width:1120px!important}
 .hero{border-radius:16px!important;padding:20px!important}
 ...
 .section-head h2{min-width:0!important}
 .action-row{width:100%!important}
 .paper{width:100%!important;padding:20px!important}
 .paper-head{flex-direction:column!important}
 .paper-meta{text-align:left!important}
 .customers-v2-head{width:100%!important}
 .customers-v2-toolbar{width:100%!important}
 .customers-v2-grid{width:100%!important}
 .customers-v2-card{width:100%!important}
 .customers-v2-form{width:100%!important}
 .customers-v2-form-actions{bottom:76px!important}
}
@media(max-width:600px){
 .screen{padding:20px 14px 30px!important}
 ...
 .customers-v2-head{align-items:flex-start!important}
 .customers-v2-form-actions{position:sticky!important;bottom:76px!important}
}
