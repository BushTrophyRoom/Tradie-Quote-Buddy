const CACHE_NAME = 'tradie-quote-buddy-v23';
const APP_SHELL = [
  './', './index.html', './app-v7.js?v=10', './dashboard-layout.js?v=2',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith(caches.match(event.request).then(cached => (cached ? Promise.resolve(cached) : fetch(event.request)).then(response => {
