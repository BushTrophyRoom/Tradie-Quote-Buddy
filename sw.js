const CACHE_NAME = 'tradie-quote-buddy-v30';
const APP_SHELL = [
  './', './index.html', './app-v7.js?v=10', './dashboard-layout.js?v=4',
  './response-actions.js?v=12', './quote-terms.js?v=2', './customer-send.js?v=3', './invoice.js?v=1', './respond.html',
      ...
      return fetch(event.request).then(response => {
        ...
        if (url.origin === self.location.origin && url.pathname.endsWith('/app-v7.js')) {
          return response.text().then(text => new Response(
            ...
            '(function(){var s=document.createElement("script");s.src="./invoice.js?v=1";document.head.appendChild(s);})();\n',
