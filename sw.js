...
const ASSETS=['./','./index.html','./app.js','./manifest.webmanifest','./icon.svg','./subscription.html'];
...
self.addEventListener('fetch',event=>{
  ...
  const isAppFile=['/index.html','/app.js','/sw.js','/manifest.webmanifest'].some(p=>url.pathname.endsWith(p));
  if(isAppFile){
