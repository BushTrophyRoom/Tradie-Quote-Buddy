(function(){
  ...
  function registerFreshWorker(){
    ...
    navigator.serviceWorker.register('./sw.js?v=74',{updateViaCache:'none'}).then(function(reg){
  ...
  function hardResetThenStart(){
    ...
    Promise.all(jobs).then(function(){registerFreshWorker();loadScript('./invoice-fix.js?v=66');loadScript('./pwa-install.js?v=1');loadScript('./invoice-created-notice.js?v=1');loadScript('./invoice-state-guard.js?v=1');try{window.location.reload()}catch(e){}})
  }
  ...
  loadScript('./invoice-state-guard.js?v=1');
  registerFreshWorker();
